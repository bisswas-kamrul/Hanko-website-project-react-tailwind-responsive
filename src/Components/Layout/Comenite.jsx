        ...
        <div
          ...
          <Flex className={"flex-col sm:flex-row"}>
            <div className="w-[585px]">
              <h3 className="text-[16px]  font-HeaderTextColor font-semibold  text-white md:pl-5 pt-5">
            ...
            <div className="">
              <input
                className=" h-[40px] w-[350px] bg-white shadow-sm rounded-4xl mt-10 mr-3 text-black uppercase font-semibold font-HeaderTextColor"
